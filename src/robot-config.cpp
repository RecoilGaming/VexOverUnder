...
drivetrain Drivetrain = drivetrain(LeftDriveSmart, RightDriveSmart, 299.24, 323.84999999999997, 203.2, mm, 1);
motor CatapultMotorA = motor(PORT12, ratio36_1, false);
motor CatapultMotorB = motor(PORT19, ratio36_1, true);
